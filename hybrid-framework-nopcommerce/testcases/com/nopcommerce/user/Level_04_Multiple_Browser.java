...
//        }
        ...
        //C2: đưa vào trong 1 hàm
        driver = getBrowserDriver(browserName);
//        driver = getBrowserDriver(browserName, "https://demo.nopcommerce.com/");

        //chạy bằng headless browser
//        driver = getBrowserDriverAndHeadless(browserName);

        //những lệnh này nên đưa vào trong hàm getBrowserDriver luôn
